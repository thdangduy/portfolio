...
export default function BlogEditor({ initialPost }: BlogEditorProps) {
	...
	const [authorName, setAuthorName] = useState(initialPost?.authorName || "Avisek");
		...
		try {
			...
			const response = await fetch("/api/blog", {
				...
				body: JSON.stringify({
					...
					published: publish,
					originalSlug: initialPost?.slug, // Send original slug for updates
				}),
			});
	...
	const markdownCompletions = (context: CompletionContext) => {
		...
		return {
			...
			options: [
				...
				{ label: "*italic*", type: "keyword", info: "Italic Text", detail: "Italic" },
				...
				{ label: "```\ncode\n```", type: "keyword", info: "Code Block", detail: "Code" },
				...
				{ label: "| Col | Col |\n| --- | --- |\n| Val | Val |", type: "keyword", info: "Table", detail: "Table" },
			]
		};
	};

	return (
		<div className={cn("min-h-screen p-8 text-blog-fg", JetBrainsMono.className)}>
			<div className="max-w-[1800px] mx-auto">
				<div className="mb-8">
					<h1 className="text-4xl font-bold text-blog-orange mb-2">Blog Editor</h1>
					<p className="text-blog-fg opacity-80">Write your blog post with live preview</p>
				</div>
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
					<div className="space-y-6">
						<div className="bg-blog-bg border border-blog-inactive-border rounded-lg p-6">
							...
							<div className="space-y-4">
								<div>
									<Label htmlFor="title" className="text-blog-fg">Title *</Label>
									<Input
										id="title"
										value={title}
								...
								<div>
									<Label htmlFor="excerpt" className="text-blog-fg">Excerpt *</Label>
									<Input
										id="excerpt"
										value={excerpt}
								...
								<div>
									<Label htmlFor="author" className="text-blog-fg">Author Name</Label>
									<Input
										id="author"
										value={authorName}
								...
								<div>
									<Label htmlFor="coverImage" className="text-blog-fg">Cover Image URL (optional)</Label>
									<Input
										id="coverImage"
										value={coverImage}
						...
						<div className="bg-blog-bg border border-blog-inactive-border rounded-lg p-6">
							<h2 className="text-2xl font-bold text-blog-orange mb-4">Content *</h2>
							<p className="text-sm text-blog-fg opacity-70 mb-4">
								Write your content in Markdown format (Ctrl+Space for suggestions)
							</p>
					...
					<div className="lg:sticky lg:top-8 lg:h-[calc(100vh-4rem)]">
						<div className="bg-blog-bg border border-blog-inactive-border rounded-lg p-6 h-full overflow-y-auto">
							<h2 className="text-2xl font-bold text-blog-orange mb-6">Live Preview</h2>
