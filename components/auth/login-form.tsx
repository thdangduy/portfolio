...
export default function LoginForm() {
  ...
  return (
    <div
      className={cn(
        "w-full max-w-md mx-auto p-6 bg-blog-bg border border-blog-inactive-border rounded-lg",
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-blog-fg">
            Admin Secret
          </label>
          <input
            type="password"
      ...
      <div className="mt-8 pt-6 border-t border-blog-inactive-border text-center">
        <Link
          href="/"
          className="text-sm text-blog-fg/40 hover:text-blog-fg transition-colors"
        >
          ← Back to portfolio
        </Link>
      </div>
