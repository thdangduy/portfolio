...
ENV NEXT_PUBLIC_BASE_URL=${NEXT_PUBLIC_BASE_URL:-https://portfolio.thaiduy.digital}
ENV NEXT_PUBLIC_GOOGLE_ANALYTICS=$NEXT_PUBLIC_GOOGLE_ANALYTICS
ENV NEXT_PUBLIC_CLOUDFLARE_R2_BASE_URL=${NEXT_PUBLIC_CLOUDFLARE_R2_BASE_URL:-https://drive.thaiduy.store/portfolio/images}
